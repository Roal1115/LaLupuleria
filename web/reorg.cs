/*
       ...
       Generated on: 10/11/2018 18:47:44.93
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void CreateSchoolInfoTrs( )
      {
         String cmdBuffer = "" ;
         /* Indices for table SchoolInfoTrs */
         try
         {
            cmdBuffer=" CREATE TABLE [SchoolInfoTrs] ([SchoolInfoTrsId]  smallint NOT NULL  IDENTITY(1,1), [SchoolInfoTrsNombre]  char(200) NOT NULL , [SchoolInfoTrsSolgan]  char(200) NOT NULL , [SchoolInfoTrsAddress]  varchar(1024) NOT NULL , [SchoolInfoTrsPhone]  char(20) NOT NULL , [SchoolInfoTrsImagen]  VARBINARY(MAX) NOT NULL , [SchoolInfoTrsImagen_GXI]  varchar(2048) NOT NULL , PRIMARY KEY([SchoolInfoTrsId]))  "
            ;
         ...
         catch ( Exception ex )
         {
            try
            {
               DropTableConstraints( "[SchoolInfoTrs]") ;
               cmdBuffer=" DROP TABLE [SchoolInfoTrs] "
               ;
               RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
               RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
               RGZ.ExecuteStmt() ;
            ...
            catch ( Exception sqlex1 )
            {
               ...
               {
                  DropTableConstraints( "[SchoolInfoTrs]") ;
                  cmdBuffer=" DROP VIEW [SchoolInfoTrs] "
                  ;
                  RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
                  RGZ.ErrorMask = GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK;
                  RGZ.ExecuteStmt() ;
               ...
               catch ( Exception sqlex2 )
               {
                  ...
                  {
                     DropTableConstraints( "[SchoolInfoTrs]") ;
                     cmdBuffer=" DROP FUNCTION [SchoolInfoTrs] "
                     ;
                     RGZ = new GxCommand(dsDefault.Db, cmdBuffer, dsDefault,0,true,false,null);
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( tableexist("SchoolInfoTrs",sSchemaVar) )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_table_exist", new   object[]  {"SchoolInfoTrs"}) ) ;
            return false ;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "CreateSchoolInfoTrs" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_filecrea", new   object[]  {"SchoolInfoTrs", ""}) );
      }
