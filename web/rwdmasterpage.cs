/*
       ...
       Generated on: 10/11/2018 18:52:41.50
...
namespace GeneXus.Programs {
   public class rwdmasterpage : GXMasterPage, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlCloseForm042( )
      {
         ...
         context.AddJavascriptSource("rwdmasterpage.js", "?2018101118524152", false);
      ...
      protected void WB040( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblApplicationheader_Internalname, "Escuela", "", "", lblApplicationheader_Jsonclick, "'"+""+"'"+",true,"+"'"+"E_MPAGE."+"'", "", "TextBlockHeader", 0, "", 1, 1, 0, "HLP_RwdMasterPage.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton1_Internalname, "", "Clientes", bttButton1_Jsonclick, 7, "Clientes", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e11041_client"+"'", TempTags, "", 2, "HLP_RwdMasterPage.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "BtnEnter";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton2_Internalname, "", "Dispositivos", bttButton2_Jsonclick, 7, "Dispositivos", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e12041_client"+"'", TempTags, "", 2, "HLP_RwdMasterPage.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "gx-button", "left", "top", "", "", "div");
            ...
            ClassString = "BtnEnter";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttButton3_Internalname, "", "Notification", bttButton3_Jsonclick, 7, "Notification", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",true,"+"'"+"e13041_client"+"'", TempTags, "", 2, "HLP_RwdMasterPage.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "MPW0026"+"", StringUtil.RTrim( WebComp_Wcrecentlinks_Component));
               context.WriteHtmlText( "<div") ;
            ...
            if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) && ! wbErr )
            {
               ...
               if ( StringUtil.Len( sEvt) > 0 )
               {
                  ...
                  else if ( StringUtil.StrCmp(sEvtType, "M") == 0 )
                  {
                     ...
                     if ( nCmpId == 26 )
                     {
                        OldWcrecentlinks = cgiGet( "MPW0026");
                        ...
                        if ( StringUtil.Len( WebComp_Wcrecentlinks_Component) != 0 )
                        {
                           WebComp_Wcrecentlinks.componentprocess("MPW0026", "", sEvt);
                        }
                        WebComp_Wcrecentlinks_Component = OldWcrecentlinks;
                     }
                  }
      ...
      protected void E15042( )
      {
         ...
         if ( StringUtil.Len( WebComp_Wcrecentlinks_Component) != 0 )
         {
            ...
            WebComp_Wcrecentlinks.componentprepare(new Object[] {(String)"MPW0026",(String)"",(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Caption,Contentholder.Pgmname});
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)(getDataAreaObject() == null ? Form : getDataAreaObject().GetForm()).Jscriptsrc.Item(idxLst))), "?2018101118524184", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      {
         context.AddJavascriptSource("rwdmasterpage.js", "?2018101118524184", false);
      ...
      protected void init_default_properties( )
      {
         ...
         bttButton3_Internalname = "BUTTON3_MPAGE";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("CLIENTES_MPAGE","{handler:'E11041',iparms:[]");
         setEventMetadata("CLIENTES_MPAGE",",oparms:[]}");
         setEventMetadata("DISPOSITIVOS_MPAGE","{handler:'E12041',iparms:[]");
         setEventMetadata("DISPOSITIVOS_MPAGE",",oparms:[]}");
         setEventMetadata("SEND NOTIFICATION_MPAGE","{handler:'E13041',iparms:[]");
         setEventMetadata("SEND NOTIFICATION_MPAGE",",oparms:[]}");
         return  ;
      }
