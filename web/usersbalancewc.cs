/*
               File: UsersBalanceWC
        Description: Users Balance WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/11/2018 18:52:8.56
...
namespace GeneXus.Programs {
   public class usersbalancewc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public usersbalancewc( )
      {
      ...
      public usersbalancewc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Users Balance WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?201810111852866", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("usersbalancewc.aspx") + "?" + UrlEncode("" +AV6UsersId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0G2( )
      {
         ...
         {
            context.AddJavascriptSource("usersbalancewc.js", "?201810111852869", false);
         }
      ...
      {
         return "UsersBalanceWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Users Balance WC" ;
      }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "usersbalancewc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_UsersBalanceWC.htm");
      ...
      protected void START0G2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Users Balance WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BALANCEID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A7BalanceId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"BALANCEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A7BalanceId), 4, 0, ".", "")));
      }
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A30BalanceLastLine = H000G3_A30BalanceLastLine[0];
               A29BalanceName = H000G3_A29BalanceName[0];
               A28BalanceMonths = H000G3_A28BalanceMonths[0];
               A27BalanceDateMade = H000G3_A27BalanceDateMade[0];
               A7BalanceId = H000G3_A7BalanceId[0];
               A32BalanceTotalAbono = H000G3_A32BalanceTotalAbono[0];
               n32BalanceTotalAbono = H000G3_n32BalanceTotalAbono[0];
               A24BalanceCredit = H000G3_A24BalanceCredit[0];
               A32BalanceTotalAbono = H000G3_A32BalanceTotalAbono[0];
               n32BalanceTotalAbono = H000G3_n32BalanceTotalAbono[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_BALANCEID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A7BalanceId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Balance";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "usersbalancewc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201810111852103", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("usersbalancewc.js", "?201810111852104", false);
         }
      ...
      {
         edtBalanceId_Internalname = sPrefix+"BALANCEID_"+sGXsfl_20_idx;
         edtBalanceCredit_Internalname = sPrefix+"BALANCECREDIT_"+sGXsfl_20_idx;
         edtBalanceDateMade_Internalname = sPrefix+"BALANCEDATEMADE_"+sGXsfl_20_idx;
         edtBalanceMonths_Internalname = sPrefix+"BALANCEMONTHS_"+sGXsfl_20_idx;
         cmbBalanceName_Internalname = sPrefix+"BALANCENAME_"+sGXsfl_20_idx;
         edtBalanceTotalAbono_Internalname = sPrefix+"BALANCETOTALABONO_"+sGXsfl_20_idx;
         edtBalanceSaldo_Internalname = sPrefix+"BALANCESALDO_"+sGXsfl_20_idx;
         edtBalanceLastLine_Internalname = sPrefix+"BALANCELASTLINE_"+sGXsfl_20_idx;
      ...
      {
         edtBalanceId_Internalname = sPrefix+"BALANCEID_"+sGXsfl_20_fel_idx;
         edtBalanceCredit_Internalname = sPrefix+"BALANCECREDIT_"+sGXsfl_20_fel_idx;
         edtBalanceDateMade_Internalname = sPrefix+"BALANCEDATEMADE_"+sGXsfl_20_fel_idx;
         edtBalanceMonths_Internalname = sPrefix+"BALANCEMONTHS_"+sGXsfl_20_fel_idx;
         cmbBalanceName_Internalname = sPrefix+"BALANCENAME_"+sGXsfl_20_fel_idx;
         edtBalanceTotalAbono_Internalname = sPrefix+"BALANCETOTALABONO_"+sGXsfl_20_fel_idx;
         edtBalanceSaldo_Internalname = sPrefix+"BALANCESALDO_"+sGXsfl_20_fel_idx;
         edtBalanceLastLine_Internalname = sPrefix+"BALANCELASTLINE_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtBalanceCredit_Internalname,StringUtil.LTrim( StringUtil.NToC( A24BalanceCredit, 14, 2, ",", "")),context.localUtil.Format( A24BalanceCredit, "$ Z,ZZZ,ZZZ.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)edtBalanceCredit_Link,(String)"",(String)"",(String)"",(String)edtBalanceCredit_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)14,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Currency",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtBalanceDateMade_Internalname,context.localUtil.Format(A27BalanceDateMade, "99/99/99"),context.localUtil.Format( A27BalanceDateMade, "99/99/99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtBalanceDateMade_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)8,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtBalanceMonths_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A28BalanceMonths), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A28BalanceMonths), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtBalanceMonths_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            {
               GXCCtl = "BALANCENAME_" + sGXsfl_20_idx;
            ...
            context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, cmbBalanceName_Internalname, "Values", (String)(cmbBalanceName.ToJavascriptSource()), !bGXsfl_20_Refreshing);
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtBalanceSaldo_Internalname,StringUtil.LTrim( StringUtil.NToC( A34BalanceSaldo, 14, 2, ",", "")),context.localUtil.Format( A34BalanceSaldo, "$ Z,ZZZ,ZZZ.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtBalanceSaldo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)14,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"Currency",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+"display:none;"+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtBalanceLastLine_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A30BalanceLastLine), 4, 0, ",", "")),context.localUtil.Format( (decimal)(A30BalanceLastLine), "ZZZ9"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtBalanceLastLine_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)0,(short)0,(short)0,(String)"number",(String)"1",(short)0,(String)"px",(short)17,(String)"px",(short)4,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130G2',iparms:[{av:'A7BalanceId',fld:'BALANCEID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110G2',iparms:[{av:'A7BalanceId',fld:'BALANCEID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000G3_A3UsersId = new short[1] ;
         H000G3_A30BalanceLastLine = new short[1] ;
         H000G3_A29BalanceName = new String[] {""} ;
         H000G3_A28BalanceMonths = new short[1] ;
         H000G3_A27BalanceDateMade = new DateTime[] {DateTime.MinValue} ;
         H000G3_A7BalanceId = new short[1] ;
         H000G3_A32BalanceTotalAbono = new decimal[1] ;
         H000G3_n32BalanceTotalAbono = new bool[] {false} ;
         H000G3_A24BalanceCredit = new decimal[1] ;
         ...
         ROClassString = "";
         GXCCtl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.usersbalancewc__default(),
            new Object[][] {
                new Object[] {
               H000G3_A3UsersId, H000G3_A30BalanceLastLine, H000G3_A29BalanceName, H000G3_A28BalanceMonths, H000G3_A27BalanceDateMade, H000G3_A7BalanceId, H000G3_A32BalanceTotalAbono, H000G3_n32BalanceTotalAbono, H000G3_A24BalanceCredit
               }
               , new Object[] {
      ...
      private short[] H000G3_A3UsersId ;
      private short[] H000G3_A30BalanceLastLine ;
      private String[] H000G3_A29BalanceName ;
      private short[] H000G3_A28BalanceMonths ;
      private DateTime[] H000G3_A27BalanceDateMade ;
      private short[] H000G3_A7BalanceId ;
      private decimal[] H000G3_A32BalanceTotalAbono ;
      private bool[] H000G3_n32BalanceTotalAbono ;
      private decimal[] H000G3_A24BalanceCredit ;
   ...
   public class usersbalancewc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H000G3", "SELECT T1.[UsersId], T1.[BalanceLastLine], T1.[BalanceName], T1.[BalanceMonths], T1.[BalanceDateMade], T1.[BalanceId], COALESCE( T2.[BalanceTotalAbono], 0) AS BalanceTotalAbono, T1.[BalanceCredit] FROM ([Balance] T1 WITH (NOLOCK) LEFT JOIN (SELECT SUM([HistoryAbono]) AS BalanceTotalAbono, [BalanceId] FROM [BalanceHistory] WITH (NOLOCK) GROUP BY [BalanceId] ) T2 ON T2.[BalanceId] = T1.[BalanceId]) WHERE T1.[UsersId] = @AV6UsersId ORDER BY T1.[UsersId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G3,11,0,true,false )
             ,new CursorDef("H000G5", "SELECT COUNT(*) FROM ([Balance] T1 WITH (NOLOCK) LEFT JOIN (SELECT SUM([HistoryAbono]) AS BalanceTotalAbono, [BalanceId] FROM [BalanceHistory] WITH (NOLOCK) GROUP BY [BalanceId] ) T2 ON T2.[BalanceId] = T1.[BalanceId]) WHERE T1.[UsersId] = @AV6UsersId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000G5,1,0,true,false )
          };
       }
    }
