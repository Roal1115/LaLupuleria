/*
               File: UsersDineroWC
        Description: Users Dinero WC
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/11/2018 18:52:27.58
...
namespace GeneXus.Programs {
   public class usersdinerowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public usersdinerowc( )
      {
      ...
      public usersdinerowc( IGxContext context )
      {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Users Dinero WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2018101118522768", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("usersdinerowc.aspx") + "?" + UrlEncode("" +AV6UsersId)+"\">") ;
      ...
      protected void RenderHtmlCloseForm0J2( )
      {
         ...
         {
            context.AddJavascriptSource("usersdinerowc.js", "?2018101118522772", false);
         }
      ...
      {
         return "UsersDineroWC" ;
      }

      public override String GetPgmdesc( )
      {
         return "Users Dinero WC" ;
      }
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "usersdinerowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Agregar", bttBtninsert_Jsonclick, 5, "Agregar", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_UsersDineroWC.htm");
      ...
      protected void START0J2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Users Dinero WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DINEROID", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A14DineroId), "ZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"DINEROID", StringUtil.LTrim( StringUtil.NToC( (decimal)(A14DineroId), 4, 0, ".", "")));
      }
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A14DineroId = H000J2_A14DineroId[0];
               A64DineroTotal = H000J2_A64DineroTotal[0];
               A63DineroAbono = H000J2_A63DineroAbono[0];
               A62DineroPago = H000J2_A62DineroPago[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_DINEROID"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A14DineroId), "ZZZ9"), context));
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Dinero";
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "usersdinerowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2018101118522866", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("usersdinerowc.js", "?2018101118522867", false);
         }
      ...
      {
         edtDineroId_Internalname = sPrefix+"DINEROID_"+sGXsfl_20_idx;
         edtDineroTotal_Internalname = sPrefix+"DINEROTOTAL_"+sGXsfl_20_idx;
         edtDineroPago_Internalname = sPrefix+"DINEROPAGO_"+sGXsfl_20_idx;
         edtDineroAbono_Internalname = sPrefix+"DINEROABONO_"+sGXsfl_20_idx;
         edtDineroNuevo_Internalname = sPrefix+"DINERONUEVO_"+sGXsfl_20_idx;
         edtDineroBalance_Internalname = sPrefix+"DINEROBALANCE_"+sGXsfl_20_idx;
      ...
      {
         edtDineroId_Internalname = sPrefix+"DINEROID_"+sGXsfl_20_fel_idx;
         edtDineroTotal_Internalname = sPrefix+"DINEROTOTAL_"+sGXsfl_20_fel_idx;
         edtDineroPago_Internalname = sPrefix+"DINEROPAGO_"+sGXsfl_20_fel_idx;
         edtDineroAbono_Internalname = sPrefix+"DINEROABONO_"+sGXsfl_20_fel_idx;
         edtDineroNuevo_Internalname = sPrefix+"DINERONUEVO_"+sGXsfl_20_fel_idx;
         edtDineroBalance_Internalname = sPrefix+"DINEROBALANCE_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDineroTotal_Internalname,StringUtil.LTrim( StringUtil.NToC( A64DineroTotal, 10, 2, ",", "")),context.localUtil.Format( A64DineroTotal, "ZZZ,ZZ9.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)edtDineroTotal_Link,(String)"",(String)"",(String)"",(String)edtDineroTotal_Jsonclick,(short)0,(String)"DescriptionAttribute",(String)"",(String)ROClassString,(String)"WWColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)10,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDineroPago_Internalname,StringUtil.LTrim( StringUtil.NToC( A62DineroPago, 10, 2, ",", "")),context.localUtil.Format( A62DineroPago, "ZZZ,ZZ9.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtDineroPago_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)10,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDineroAbono_Internalname,StringUtil.LTrim( StringUtil.NToC( A63DineroAbono, 12, 2, ",", "")),context.localUtil.Format( A63DineroAbono, "+ ZZZ,ZZ9.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtDineroAbono_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)12,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtDineroNuevo_Internalname,StringUtil.LTrim( StringUtil.NToC( A65DineroNuevo, 10, 2, ",", "")),context.localUtil.Format( A65DineroNuevo, "ZZZ,ZZ9.99"),(String)"",(String)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(String)"",(String)"",(String)"",(String)"",(String)edtDineroNuevo_Jsonclick,(short)0,(String)"Attribute",(String)"",(String)ROClassString,(String)"WWColumn WWOptionalColumn",(String)"",(short)-1,(short)0,(short)0,(String)"text",(String)"",(short)0,(String)"px",(short)17,(String)"px",(short)10,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(String)"",(String)"right",(bool)false});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtDineroId_Internalname = sPrefix+"DINEROID";
         edtDineroTotal_Internalname = sPrefix+"DINEROTOTAL";
         edtDineroPago_Internalname = sPrefix+"DINEROPAGO";
         edtDineroAbono_Internalname = sPrefix+"DINEROABONO";
         edtDineroNuevo_Internalname = sPrefix+"DINERONUEVO";
         edtDineroBalance_Internalname = sPrefix+"DINEROBALANCE";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E130J2',iparms:[{av:'A14DineroId',fld:'DINEROID',pic:'ZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110J2',iparms:[{av:'A14DineroId',fld:'DINEROID',pic:'ZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H000J2_A3UsersId = new short[1] ;
         H000J2_A14DineroId = new short[1] ;
         H000J2_A64DineroTotal = new decimal[1] ;
         H000J2_A63DineroAbono = new decimal[1] ;
         H000J2_A62DineroPago = new decimal[1] ;
         ...
         sCtrlAV6UsersId = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.usersdinerowc__default(),
            new Object[][] {
                new Object[] {
               H000J2_A3UsersId, H000J2_A14DineroId, H000J2_A64DineroTotal, H000J2_A63DineroAbono, H000J2_A62DineroPago
               }
               , new Object[] {
      ...
      private short[] H000J2_A3UsersId ;
      private short[] H000J2_A14DineroId ;
      private decimal[] H000J2_A64DineroTotal ;
      private decimal[] H000J2_A63DineroAbono ;
      private decimal[] H000J2_A62DineroPago ;
   ...
   public class usersdinerowc__default : DataStoreHelperBase, IDataStoreHelper
   {
