...
using System.IO;
public class bldpushtestmain : GxBaseBuilder
{
   string cs_path = "." ;
   public bldpushtestmain( ) : base()
   {
   }
   ...
   {
      bldpushtestmain x = new bldpushtestmain() ;
      x.SetMainSourceFile( "pushtestmain.cs");
