/*
               File: Gx0021
        Description: Selection List Group
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/11/2018 18:53:1.92
...
namespace GeneXus.Programs {
   public class gx0021 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( String aP0_pDeviceId ,
                           out short aP1_pGroupId )
      {
         this.AV7pDeviceId = aP0_pDeviceId;
         this.AV8pGroupId = 0 ;
         executePrivate();
         aP1_pGroupId=this.AV8pGroupId;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cGroupId) ;
            ...
            {
               AV7pDeviceId = gxfirstwebparm;
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7pDeviceId", AV7pDeviceId);
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pGroupId = (short)(NumberUtil.Val( GetNextPar( ), "."));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201810111853197", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0021.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7pDeviceId)) + "," + UrlEncode("" +AV8pGroupId)+"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPDEVICEID", AV7pDeviceId);
      ...
      {
         return formatLink("gx0021.aspx") + "?" + UrlEncode(StringUtil.RTrim(AV7pDeviceId)) + "," + UrlEncode("" +AV8pGroupId) ;
      }
      ...
      protected void WB1D0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblgroupidfilter_Internalname, "Grupo Id", "", "", lblLblgroupidfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111d1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 1, "HLP_Gx0021.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121d1_client"+"'", TempTags, "", 2, "HLP_Gx0021.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Column.AddObjectProperty("Link", StringUtil.RTrim( edtGroupId_Link));
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
         ...
         if ( wbEnd == 24 )
         {
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtn_cancel_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "Cancelar", bttBtn_cancel_Jsonclick, 1, "Cancelar", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"ECANCEL."+"'", TempTags, "", context.GetButtonType( ), "HLP_Gx0021.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1D2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Group", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF1D2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001D2 */
            pr_default.execute(0, new Object[] {AV6cGroupId, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrim( StringUtil.Str( (decimal)(nGXsfl_24_idx), 4, 0)), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( 10 == 0 ) || ( GRID1_nCurrentRecord < subGrid1_Recordsperpage( ) ) ) ) )
            {
               A1DeviceId = H001D2_A1DeviceId[0];
               A6GroupId = H001D2_A6GroupId[0];
               /* Execute user event: Load */
               E141D2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_GROUPID"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A6GroupId), "ZZZ9"), context));
      }
      ...
      {
         /* Using cursor H001D3 */
         pr_default.execute(1, new Object[] {AV6cGroupId});
      ...
      {
         /* Start Routine */
         Form.Caption = StringUtil.Format( "Lista de Selección %1", "Group", "", "", "", "", "", "", "", "");
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pDeviceId = (String)getParm(obj,0);
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV7pDeviceId", AV7pDeviceId);
         AV8pGroupId = Convert.ToInt16(getParm(obj,1));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV8pGroupId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV8pGroupId), 4, 0)));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?201810111853261", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0021.js", "?201810111853262", false);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtGroupId_Internalname = "GROUPID_"+sGXsfl_24_idx;
         edtDeviceId_Internalname = "DEVICEID_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_24_fel_idx;
         edtGroupId_Internalname = "GROUPID_"+sGXsfl_24_fel_idx;
         edtDeviceId_Internalname = "DEVICEID_"+sGXsfl_24_fel_idx;
      }
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Group";
         subGrid1_Rows = 10;
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cGroupId',fld:'vCGROUPID',pic:'ZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E121D1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLGROUPIDFILTER.CLICK","{handler:'E111D1',iparms:[{av:'divGroupidfiltercontainer_Class',ctrl:'GROUPIDFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E151D2',iparms:[{av:'A6GroupId',fld:'GROUPID',pic:'ZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pGroupId',fld:'vPGROUPID',pic:'ZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cGroupId',fld:'vCGROUPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cGroupId',fld:'vCGROUPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cGroupId',fld:'vCGROUPID',pic:'ZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cGroupId',fld:'vCGROUPID',pic:'ZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001D2_A1DeviceId = new String[] {""} ;
         H001D2_A6GroupId = new short[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0021__default(),
            new Object[][] {
                new Object[] {
               H001D2_A1DeviceId, H001D2_A6GroupId
               }
               , new Object[] {
      ...
      private String edtGroupId_Link ;
      ...
      private String AV7pDeviceId ;
      private String wcpOAV7pDeviceId ;
      ...
      private String[] H001D2_A1DeviceId ;
      private short[] H001D2_A6GroupId ;
      private long[] H001D3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private short aP1_pGroupId ;
   ...
   public class gx0021__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001D2", "SELECT [DeviceId], [GroupId] FROM [DevicesGroup] WITH (NOLOCK) WHERE [GroupId] >= @AV6cGroupId ORDER BY [DeviceId], [GroupId]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D2,11,0,false,false )
             ,new CursorDef("H001D3", "SELECT COUNT(*) FROM [DevicesGroup] WITH (NOLOCK) WHERE [GroupId] >= @AV6cGroupId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001D3,1,0,false,false )
          };
       }
    }
