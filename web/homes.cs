/*
       ...
       Generated on: 10/11/2018 18:52:42.0
...
namespace GeneXus.Programs {
   public class homes : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public homes( )
      {
      ...
      public homes( IGxContext context )
      {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?201810111852424", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"Form\" data-gx-class=\"Form\" novalidate action=\""+formatLink("homes.aspx") +"\">") ;
      ...
      protected void START072( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Homes", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2018101118524221", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("homes.js", "?2018101118524221", false);
         }
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         AV5MenuItem = "";
         AV6ProgramNames = new GXBaseCollection<SdtProgramNames_ProgramName>( context, "ProgramName", "Verbo2");
