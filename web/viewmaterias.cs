/*
               File: ViewMaterias
        Description: View Materias
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/11/2018 18:52:50.38
...
namespace GeneXus.Programs {
   public class viewmaterias : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewmaterias( )
      {
      ...
      public viewmaterias( IGxContext context )
      {
      ...
      public void execute( short aP0_MateriasId ,
                           String aP1_TabCode )
      {
         this.AV12MateriasId = aP0_MateriasId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12MateriasId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12MateriasId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12MateriasId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vMATERIASID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12MateriasId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2018101118525043", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewmaterias.aspx") + "?" + UrlEncode("" +AV12MateriasId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewMaterias";
         forbiddenHiddens = forbiddenHiddens + StringUtil.RTrim( context.localUtil.Format( A48MateriasNombre, ""));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewmaterias:[SendSecurityCheck value for]"+"MateriasNombre:"+StringUtil.RTrim( context.localUtil.Format( A48MateriasNombre, "")));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vMATERIASID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12MateriasId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vMATERIASID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12MateriasId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewmaterias.aspx") + "?" + UrlEncode("" +AV12MateriasId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Materias Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewMaterias.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Materias", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewMaterias.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewMaterias.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblCalifas_title_Internalname, "Califas", "", "", lblCalifas_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewMaterias.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
            ...
            {
               /* WebComponent */
               GxWebStd.gx_hidden_field( context, "W0038"+"", StringUtil.RTrim( WebComp_Califaswc_Component));
               context.WriteHtmlText( "<div") ;
               GxWebStd.ClassAttribute( context, "gxwebcomponent");
      ...
      protected void START0X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Materias", 0) ;
         }
         context.wjLoc = "";
                  ...
                  if ( StringUtil.StrCmp(sEvtType, "M") != 0 )
                  {
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 38 )
                        {
                           ...
                           if ( StringUtil.Len( WebComp_Califaswc_Component) != 0 )
                           {
                              WebComp_Califaswc.componentprocess("W0038", "", sEvt);
                           }
                           WebComp_Califaswc_Component = OldCalifaswc;
                        }
                     }
      ...
      protected void RF0X2( )
      {
         ...
         {
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {AV12MateriasId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A11MateriasId = H000X2_A11MateriasId[0];
               A48MateriasNombre = H000X2_A48MateriasNombre[0];
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A48MateriasNombre", A48MateriasNombre);
            /* Read saved values. */
            AV12MateriasId = (short)(context.localUtil.CToN( cgiGet( "vMATERIASID"), ",", "."));
            ...
            {
               GXUtil.WriteLog("viewmaterias:[SecurityCheckFailed value for]"+"MateriasNombre:"+StringUtil.RTrim( context.localUtil.Format( A48MateriasNombre, "")));
               GxWebError = 1;
      ...
      protected void E110X2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000X3 */
         pr_default.execute(1, new Object[] {AV12MateriasId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A11MateriasId = H000X3_A11MateriasId[0];
            A48MateriasNombre = H000X3_A48MateriasNombre[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A48MateriasNombre", A48MateriasNombre);
            AV16GXLvl6 = 1;
            Form.Caption = A48MateriasNombre;
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwmaterias.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "MateriasGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "materiasgeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "MateriasGeneral";
               WebComp_Generalwc_Component = "MateriasGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12MateriasId});
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Califaswc_Component), StringUtil.Lower( "MateriasCalifasWC")) != 0 )
            {
               WebComp_Califaswc = getWebComponent(GetType(), "GeneXus.Programs", "materiascalifaswc", new Object[] {context} );
               WebComp_Califaswc.ComponentInit();
               WebComp_Califaswc.Name = "MateriasCalifasWC";
               WebComp_Califaswc_Component = "MateriasCalifasWC";
            }
            if ( StringUtil.Len( WebComp_Califaswc_Component) != 0 )
            {
               WebComp_Califaswc.setjustcreated();
               WebComp_Califaswc.componentprepare(new Object[] {(String)"W0038",(String)"",(short)AV12MateriasId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12MateriasId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12MateriasId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12MateriasId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vMATERIASID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12MateriasId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2018101118525099", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewmaterias.js", "?2018101118525099", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12MateriasId',fld:'vMATERIASID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A48MateriasNombre',fld:'MATERIASNOMBRE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000X2_A11MateriasId = new short[1] ;
         H000X2_A48MateriasNombre = new String[] {""} ;
         hsh = "";
         H000X3_A11MateriasId = new short[1] ;
         H000X3_A48MateriasNombre = new String[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewmaterias__default(),
            new Object[][] {
                new Object[] {
               H000X2_A11MateriasId, H000X2_A48MateriasNombre
               }
               , new Object[] {
               H000X3_A11MateriasId, H000X3_A48MateriasNombre
               }
            }
         );
      ...
      private short AV12MateriasId ;
      private short wcpOAV12MateriasId ;
      ...
      private short[] H000X2_A11MateriasId ;
      private String[] H000X2_A48MateriasNombre ;
      private short[] H000X3_A11MateriasId ;
      private String[] H000X3_A48MateriasNombre ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewmaterias__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12MateriasId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH000X3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT [MateriasId], [MateriasNombre] FROM [Materias] WITH (NOLOCK) WHERE [MateriasId] = @AV12MateriasId ORDER BY [MateriasId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,1,0,true,true )
             ,new CursorDef("H000X3", "SELECT [MateriasId], [MateriasNombre] FROM [Materias] WITH (NOLOCK) WHERE [MateriasId] = @AV12MateriasId ORDER BY [MateriasId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X3,1,0,false,true )
          };
       }
    }
