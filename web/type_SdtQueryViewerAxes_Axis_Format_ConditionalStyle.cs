...
namespace GeneXus.Programs{
	...
	[XmlType(TypeName="QueryViewerAxes.Axis.Format.ConditionalStyle" , Namespace="Verbo2" )]
	[Serializable]
	...
	[DataContract(Name=@"QueryViewerAxes.Axis.Format.ConditionalStyle", Namespace="Verbo2")]
