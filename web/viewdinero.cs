/*
               File: ViewDinero
        Description: View Dinero
             Author: GeneXus C# Generator version 15_0_12-126726
       Generated on: 10/11/2018 18:52:53.63
...
namespace GeneXus.Programs {
   public class viewdinero : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewdinero( )
      {
      ...
      public viewdinero( IGxContext context )
      {
      ...
      public void execute( short aP0_DineroId ,
                           String aP1_TabCode )
      {
         this.AV12DineroId = aP0_DineroId;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12DineroId = (short)(NumberUtil.Val( gxfirstwebparm, "."));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12DineroId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12DineroId), 4, 0)));
               context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vDINEROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12DineroId), "ZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2018101118525367", false);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewdinero.aspx") + "?" + UrlEncode("" +AV12DineroId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode))+"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens = "hsh" + "ViewDinero";
         forbiddenHiddens = forbiddenHiddens + context.localUtil.Format( A64DineroTotal, "ZZZ,ZZ9.99");
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens, GXKey));
         GXUtil.WriteLog("viewdinero:[SendSecurityCheck value for]"+"DineroTotal:"+context.localUtil.Format( A64DineroTotal, "ZZZ,ZZ9.99"));
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vDINEROID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12DineroId), 4, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vDINEROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12DineroId), "ZZZ9"), context));
      ...
      {
         return formatLink("viewdinero.aspx") + "?" + UrlEncode("" +AV12DineroId) + "," + UrlEncode(StringUtil.RTrim(AV6TabCode)) ;
      }
      ...
      protected void WB130( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Dinero Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, "HLP_ViewDinero.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Dineroes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, "HLP_ViewDinero.htm");
            ...
            GxWebStd.gx_label_element( context, edtDineroTotal_Internalname, "Total", "col-sm-3 ReadonlyAttributeLabel", 1, true);
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-sm-9 gx-attribute", "left", "top", "", "", "div");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtDineroTotal_Internalname, StringUtil.LTrim( StringUtil.NToC( A64DineroTotal, 10, 2, ",", "")), ((edtDineroTotal_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( A64DineroTotal, "ZZZ,ZZ9.99")) : context.localUtil.Format( A64DineroTotal, "ZZZ,ZZ9.99")), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtDineroTotal_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtDineroTotal_Enabled, 0, "text", "", 10, "chr", 1, "row", 10, 0, 0, 0, 1, -1, 0, true, "", "right", false, "HLP_ViewDinero.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, "HLP_ViewDinero.htm");
            /* Div Control */
      ...
      protected void START132( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Dinero", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF132( )
      {
         ...
         {
            /* Using cursor H00132 */
            pr_default.execute(0, new Object[] {AV12DineroId});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A14DineroId = H00132_A14DineroId[0];
               A64DineroTotal = H00132_A64DineroTotal[0];
      ...
      protected void STRUP130( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A64DineroTotal", StringUtil.LTrim( StringUtil.Str( A64DineroTotal, 9, 2)));
            /* Read saved values. */
            AV12DineroId = (short)(context.localUtil.CToN( cgiGet( "vDINEROID"), ",", "."));
            ...
            {
               GXUtil.WriteLog("viewdinero:[SecurityCheckFailed value for]"+"DineroTotal:"+context.localUtil.Format( A64DineroTotal, "ZZZ,ZZ9.99"));
               GxWebError = 1;
      ...
      protected void E11132( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H00133 */
         pr_default.execute(1, new Object[] {AV12DineroId});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A14DineroId = H00133_A14DineroId[0];
            A64DineroTotal = H00133_A64DineroTotal[0];
            context.httpAjaxContext.ajax_rsp_assign_attri("", false, "A64DineroTotal", StringUtil.LTrim( StringUtil.Str( A64DineroTotal, 9, 2)));
            AV16GXLvl6 = 1;
            Form.Caption = StringUtil.Str( A64DineroTotal, 9, 2);
            context.httpAjaxContext.ajax_rsp_assign_prop("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwdinero.aspx") ;
      ...
      protected void S112( )
      {
         ...
         {
            /* Object Property */
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "DineroGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "dinerogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "DineroGeneral";
               WebComp_Generalwc_Component = "DineroGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(String)"W0030",(String)"",(short)AV12DineroId});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12DineroId = Convert.ToInt16(getParm(obj,0));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "AV12DineroId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV12DineroId), 4, 0)));
         context.httpAjaxContext.ajax_rsp_assign_attri("", false, "gxhash_vDINEROID", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12DineroId), "ZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((String)Form.Jscriptsrc.Item(idxLst))), "?2018101118525416", true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewdinero.js", "?2018101118525416", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12DineroId',fld:'vDINEROID',pic:'ZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A64DineroTotal',fld:'DINEROTOTAL',pic:'ZZZ,ZZ9.99'}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H00132_A14DineroId = new short[1] ;
         H00132_A64DineroTotal = new decimal[1] ;
         hsh = "";
         H00133_A14DineroId = new short[1] ;
         H00133_A64DineroTotal = new decimal[1] ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewdinero__default(),
            new Object[][] {
                new Object[] {
               H00132_A14DineroId, H00132_A64DineroTotal
               }
               , new Object[] {
               H00133_A14DineroId, H00133_A64DineroTotal
               }
            }
         );
      ...
      private short AV12DineroId ;
      private short wcpOAV12DineroId ;
      ...
      private short[] H00132_A14DineroId ;
      private decimal[] H00132_A64DineroTotal ;
      private short[] H00133_A14DineroId ;
      private decimal[] H00133_A64DineroTotal ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewdinero__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV12DineroId",SqlDbType.SmallInt,4,0}
          } ;
          Object[] prmH00133 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H00132", "SELECT [DineroId], [DineroTotal] FROM [Dinero] WITH (NOLOCK) WHERE [DineroId] = @AV12DineroId ORDER BY [DineroId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00132,1,0,true,true )
             ,new CursorDef("H00133", "SELECT [DineroId], [DineroTotal] FROM [Dinero] WITH (NOLOCK) WHERE [DineroId] = @AV12DineroId ORDER BY [DineroId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00133,1,0,false,true )
          };
       }
    }
